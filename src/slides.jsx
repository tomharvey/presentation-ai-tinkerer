...
/* Scalloped outline generated by walking an ellipse and bulging each segment
   outward — fifteen arcs, so the edge reads as a cloud. A border-radius oval
   reads as a speech bubble, which is the wrong idea entirely. */
const CLOUD =
  'M230.0 22.0 A50.9 50.9 0 0 1 314.6 28.1 A43.2 43.2 0 0 1 384.6 45.2 ' +
  'A30.0 30.0 0 0 1 427.8 70.4 A18.2 18.2 0 0 1 436.9 99.3 ' +
  'A23.1 23.1 0 0 1 410.1 127.0 A37.1 37.1 0 0 1 352.3 148.6 ' +
  'A47.9 47.9 0 0 1 273.2 160.5 A51.9 51.9 0 0 1 186.8 160.5 ' +
  'A47.9 47.9 0 0 1 107.7 148.6 A37.1 37.1 0 0 1 49.9 127.0 ' +
  'A23.1 23.1 0 0 1 23.1 99.3 A18.2 18.2 0 0 1 32.2 70.4 ' +
  'A30.0 30.0 0 0 1 75.4 45.2 A43.2 43.2 0 0 1 145.4 28.1 ' +
  'A50.9 50.9 0 0 1 230.0 22.0 Z'
  ...
  return (
    <div className="thinksite">
      ...
      <div className="thought" key={i}>
        <svg viewBox="0 0 460 184" role="img" aria-label={PURPOSES[i]}>
          <path d={CLOUD} />
          <text x="230" y="103" textAnchor="middle">{PURPOSES[i]}</text>
        </svg>
      </div>
